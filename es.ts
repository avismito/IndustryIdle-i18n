export const ES = {
    ...
    TranslatorName: "Juan Manuel Jaén Cabrera (Leunal17), Dishito, Daniel Padilla Rodríguez (danpad01), José Luis Rodriguez (Avismito)",
    Language: "Idioma",
    ...
    PetrolPowerPlant: "Planta de energía fósil",
    Copper: "Cobre",
    Gas: "Gas natural",
    ...
    BuildingPermitDesc:
        "Tienes permisos para %{amount} edificios, ya has construido %{amountBuilt} y tienes %{amountLeft} restantes.",
    BuildingLocked:
        "El edificio aún no está disponible, primero debes desbloquearlo en el Laboratorio de investigación.",
    MaxBuilders: "Constructores máximos",
    ...
    ResourceOutput: "Salida",
    ResourceStorage: "Almacenamiento",
    ResourceChange: "Cambio",
    ResourceInOutDesc:
        "💡 Toca los números de entrada y salida de arriba para resaltar los edificios de entrada y salida correspondientes.",
    ...
    AdjacentBonusDesc:
        "Obtienes %{bonus}% capacidad adicional para cada edificio de trabajo adyacente del mismo tipo.",
    ConsiderIncreaseProduction: "💡 Considera aumentar %{resource} producción.",
    AlwaysTransportInput: "Modo de reservas",
    AlwaysTransportInputTradeCenter: "Exportar siempre",
    AlwaysTransportInputTradeCenterDesc:
        "Transporta siempre los recursos al Centro de Comercio, incluso si la venta automática no está habilitada para ese recurso.",
    AlwaysTransportInputDesc:
        "Transporta siempre los recursos de entrada, incluso si están por encima de los requisitos mínimos de producción.",
    ...
    AutoSellConcurrency: "Concurrencia de venta automática",
    ...
    MaxAutoSellConcurrencyReached:
        "Has alcanzado la concurrencia máxima de venta automática, desactiva otra venta automática para habilitar esta.",
    WallStreet: "Wall Street",
    MarketCap: "Capitalización de mercado",
    MarketCapDesc: "Capitalización de mercado total (p. ej. valor de mercado) de tu corporación",
    ...
    Credits: "Creditos",
    Icons: "Iconos",
    MisplacedBuilding: "⛔ Este %{building} no está encima del depósito de recursos correcto",
    HighlightBuildings: "Destacar edificios",
    HighlightTurnedOff: "...que están apagados",
    HighlightStockpileModeOn: "...que tienen el modo de reserva activado",
    ...
    TurnOffProductionDesc:
        "Apagar la producción del edificio. El edificio ya no transportará recursos ni utilizará energía.",
    ...
    InputStrategyClose: "Cercano",
    InputStrategyCloseDesc: "Preferir el almacén más cercano que tenga suficientes recursos.",
    InputStrategyFar: "Lejano",
    InputStrategyFarDesc: "Preferir el almacén más lejano que tenga suficientes recursos.",
    InputStrategyAmount: "Cantidad",
    InputStrategyAmountDesc:
        "Preferir el almacén con la mayor cantidad de recursos, independientemente de la distancia.",
    FuelCostSave: "Ahorro de costo de combustible",
    FuelCostSaveDescV2:
        "Los almacenes ahorran un cierto porcentaje de combustible para transportar recursos en comparación con otros edificios, cuanto más alto sea el nivel, más se ahorrará.",
    SoftwareCompany: "Compañía de software",
    Software: "Software",
    ScreenFactory: "Fábrica de pantallas",
    Screen: "Pantalla",
    JoinDiscord: "Únete a nuestro servidor de Discord para obtener las últimas actualizaciones, consejos y discusiones",
    ClaimOfflineEarning: "Reclamar ganancias sin conexión",
    OfflineTime: "Tiempo sin conexión",
    Minutes: "%{time}mínimo",
    MaxUpgrade: "Mejora máxima",
    MaxUpgradeDesc: "Has alcanzado la mejora máxima",
    ...
    MineOverlayWarning: "%{building} no es afectado por modificador de mosaico",
    ...
    NewOrder: "Un nuevo pedido de %{from} ha llegado, por favor verifica en el Centro Mayorista",
    Policies: "Políticas",
    ...
    HalfTransportSpeed: "Reducir la velocidad para ahorrar",
    ...
    RefineryMoreOilDesc: "Las refinerías de petróleo producen un 50% más de petróleo y un 50% menos de plástico",
    RefineryMorePlastic: "Más plástico, más problemas",
    RefineryMorePlasticDesc: "Las refinerías de petróleo producen un 50% menos de petróleo y un 50% más de plástico",
    ...
    SuperSteelMillDesc: "Las acerías utilizan un 50% menos de carbón, un 25% más de hierro y un 25% más de energía.",
    ...
    CostSaverDesc: "Si los insumos de un edificio cuestan más que su producción, parar la producción",
    ...
    AdjacentBonusOnlyOutputDesc:
        "La bonificación adyacente no requiere más entrada, pero usa más energía y es solo un 50% efectivo",
    ...
    ShoppingSpreeDesc:
        "Si la capacidad de producción de un recurso es insuficiente, compra la cantidad que falte en el Centro de Comercio automáticamente (si el recurso tiene la venta automática activada, se ignorará)",
    ShoppingSpreeTradeCenterDesc:
        "💡 La política Compra compulsiva está activada, el Centro de Comercio comprará automáticamente los recursos en escasez",
    ExtraPolicyPoints: "Cabildero político",
    CrAlloyUseFe: "Com-ierro",
    CrAlloyUseFeDesc: "Las plantas de aleación de cromo no usan litio, sino que usan el doble de hierro en su lugar",
    DoubleTileModifier: "Poder de la naturaleza",
    TileModifierOutputOnly: "Modificador de mosaico plus",
    GasPlantPetrol: "Licuadora de gas",
    GasPlantPetrolDesc: "Las centrales eléctricas de gas utilizan gas extra para producir petróleo",
    CoalPlantFuel: "Licuadora de carbón",
    CoalPlantFuelDesc: "Las centrales eléctricas de carbón utilizan carbón adicional para producir petróleo",
    Welcome: "Bienvenido",
    SeeTutorialAgain: "Rehacer tutorial",
    HelpTranslateTheGame: "Ayuda a traducir el juego🌐",
    NextTutorial: "Siguiente",
    Tutorial1:
        "Industry Idle es un juego de <em>administracion de recursos</em> en donde construyes fábricas🏭, para producir bienes📦 y ganar dinero💸.<br><br>Repasemos algunos conceptos básicos para que comiences - No tomará mucho tiempo, lo prometo.",
    Tutorial2:
        "Todos los edificios necesitan energía⚡, tienes una <em>turbina eólica</em> que genera poder. Puedes ver su fuente de alimentación actual en el lado izquierdo de la barra superior.<br><br>Es posible que hayas notado que las turbinas eólicas solo funcionan el <em>80%</em> del tiempo. Puedes considerar la construcción de otros tipos de plantas de energía que generen energía estable.",
    Tutorial3:
        "Tienes muchos <em>depósitos de recursos</em> en el mapa. Para extraer recursos, tienes que construir minas ⛏️ <em>sobre</em> el depósito correspondiente.<br><br>Por ejemplo, tienes un <em>pozo petrolífero🛢️</em> que extrae <em>petróleo</em> de un depósito de petróleo.<br></br>Los depósitos son ilimitados - no hay necesidad de preocuparse por quedarte sin recursos. Además de las minas, otros edificios pueden ser construidos en mosaicos vacíos.",
    Tutorial5:
        "Para ganar dinero, debes exportar tus recursos a través del Centro de Comercio. Para hacer esto, simplemente activa la <em>venta automática</em> para ese recurso.<br></br>También puedes comprar recursos en el Centro de Comercio. Recuerda <em>si compras un recurso, subirás el precio</em> y si vendes un recurso, bajarás el precio.<br><br>El mercado es <em>volátil</em>y el precio📈 cambia regularmente.",
    Tutorial6:
        "Para construir nuevos edificios, primero debes desbloquearlo en el <em>laboratorio de investigación🧪</em>. El laboratorio de investigación también convierte la ciencia en puntos de investigación.<br><br>Tu turbina eólica (y otras plantas de energía) produce una pequeña cantidad de ciencia cuando está en funcionamiento. Y puedes construir escuelas🏫 y otros edificios dedicados para impulsar la ciencia más adelante.<br><br>¡Ahora que has aprendido todos los conceptos básicos, comienza a desarrollar tu economía! Aquí hay algo de <em>efectivo💸</em> y <em>petróleo⛽</em>para impulsarte un poco.",
    WelcomePlay: "Jugar",
    WelcomePlayMuted: "Reproducir (🔇Música)",
    Chat: "Chat",
    RestoreFromBackup: "Recuperar desde copia de seguridad",
    ...
    RestoreFromBackupTitle: "¿Estás seguro?",
    RestoreFromBackupDesc:
        "Normalmente no es necesario restaurar desde la copia de seguridad en la nube, a menos que pierdas tu guardado local. Las copias de seguridad en la nube son un poco más antiguas que tu guardado local.",
    ChangeName: "Cambiar",
    SaveName: "Guardar",
    NameValidationRule: "Tu nombre solo debe contener letras y números, y tener entre 5 y 15 caracteres.",
    NameValidationRuleProfanity: "Tu nombre no debe contener profanidades.",
    ...
    OfflineModeDesc:
        "No se puede conectar al servidor: no se generarán ganancias sin conexión. Por favor revisa tu conexion a Internet",
    OptOut: "Retirarse",
    OptIn: "Restablecer y habilitar",
    LeaderboardOptOut: "Retirarse de la tabla de clasificación",
    LeaderboardOptIn: "Restablecer y habilitar la tabla de clasificación",
    LeaderboardOptInDesc:
        "Tus datos deben REINICIARSE antes de que pueda volver a habilitar la tabla de clasificación, ¿está seguro?",
    RewardAdsFailed: "El video de recompensa no se completó",
    OfflineEarningDoubleSuccess: "Has duplicado tus ingresos sin conexión",
    FPS30Desc:
        "Activar el modo de ahorro de energía ejecutará el juego a 30FPS en lugar de 60FPS. Esto hará que tu batería dure más.",
    HighlightAll: 'Destacar "%{type}"',
    HighlightInput: "🔍 Destacar %{type} Entrada",
    HighlightOutput: "🔍 Destacar %{type} Salida",
    RunOutIn: "Se agota en %{time}",
    ...
    RequireExpansionPack1Desc: "Esto solo está disponible para el paquete de expansión 1",
    ...
    RestartDesc: "💡 ¿Solo quieres reiniciar? Puedse tocar Comenzar En Una Nueva Ciudad arriba y elegir su ciudad actual.",
    ...
    SortByName: "Nombre",
    PlayerTrade: "Intercambio con jugadores",
    AddTradeFail: "Error al añadir tu intercambio",
    AddTradeExceedMaximumTrade:
        "Puedes tener solo %{number} intercambios activos, por favor reclama o cancela uno de ellos primero.",
